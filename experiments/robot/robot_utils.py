...
def get_action(
    ...
    Args:
        ...
        history_images: Optional list of (full_image,) or (full_image, wrist_image, ...) per history frame
        history_actions: Optional list of executed actions [H, action_dim] for history conditioning
        aug_mode: Optional GT aug_mode (0/1/2/3) for action head when use_aug_mode_condition is True
